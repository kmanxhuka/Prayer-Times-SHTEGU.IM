...
export declare const parse_mode = "HTML";
 ...
 */
export declare function tgEmoji(fallback: string, emojiId: string): string;
...
export declare function monospaceBlock(text: string, programmingLanguage?: string): string;
/** Create an url with a label text */
export declare function url(label: string, url: string): string;
/** Create a user mention with a label text */
export declare function userMention(label: string, userId: number): string;
